...
* bump pre-commit versions.
  (See [!1101](https://gitlab.com/esa/pyxel/-/merge_requests/1101)).
...
### 🆕 New function `pyxel.display_dataset`

New function [`pyxel.display_dataset`](https://esa.gitlab.io/pyxel/doc/stable/references/api/notebook.html#pyxel.display_dataset)
to display a Dataset generated by Pyxel.
